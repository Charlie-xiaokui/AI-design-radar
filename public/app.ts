...
const productSourceTypes = ["homepage", "release_notes", "blog", "news", "docs", "github_repo", "community", "forum", "discord", "reddit", "events", "slack", "github_releases", "github_releases_rss", "x", "youtube", "product_hunt", "rss"];
